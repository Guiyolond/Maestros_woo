...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_button_view_cart' ) ) {
	...
	function woocommerce_widget_shopping_cart_button_view_cart() {
		echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="btn button wc-forward">' . esc_html__( 'Ir al carrito', 'woocommerce' ) . '</a>';
	}
}
...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_proceed_to_checkout' ) ) {
	...
	function woocommerce_widget_shopping_cart_proceed_to_checkout() {
		echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="button checkout wc-forward">' . esc_html__( 'Finalizar compra', 'woocommerce' ) . '</a>';
	}
}
...
function wc_empty_cart_message() {
	echo '<p class="cart-empty">' . wp_kses_post( apply_filters( 'wc_empty_cart_message', __( 'Tu carrito esta vacio.', 'woocommerce' ) ) ) . '</p>';
}

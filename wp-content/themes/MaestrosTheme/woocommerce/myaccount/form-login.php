...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				...
				<input placeholder="Email" type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			...
			<p class="form-row">
				...
				<button type="submit" class="btn btn-dorado woocommerce-Button" name="login" value="<?php esc_attr_e( 'Iniciar sesión', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
					<input  type="radio" aria-label="Radio button for following text input" class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Recuerdame', 'woocommerce' ); ?></span>
				</label>
			</p>
			<p class="woocommerce-LostPassword lost_password">
				<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Olvide mi contraseña', 'woocommerce' ); ?></a>
			</p>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<h2><?php esc_html_e( 'Registrarme', 'woocommerce' ); ?></h2>
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="btn btn-dorado woocommerce-Button" name="register" value="<?php esc_attr_e( 'Registrarme', 'woocommerce' ); ?>"><?php esc_html_e( 'Registrarme', 'woocommerce' ); ?></button>
			</p>

...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Ingresa una nueva contraseña a continuación.', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="password_2"><?php esc_html_e( 'Confirmar nueva contraseña', 'woocommerce' ); ?> <span class="required">*</span></label>

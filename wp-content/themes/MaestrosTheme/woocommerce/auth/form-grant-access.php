...
<h1><?php printf( __( '%s me gustaría conectarme a tu tienda', 'woocommerce' ), esc_html( $app_name ) ); ?></h1>

<?php wc_print_notices(); ?>

<p><?php printf( __( 'Esto le dará acceso a "%1$s" %2$s que le permitirá:', 'woocommerce' ), '<strong>' . esc_html( $app_name ) . '</strong>', '<strong>' . esc_html( $scope ) . '</strong>' ); ?></p>

...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		...
		<input placeholder="Usuario o email" type="text" class="input-text" name="username" id="username" />
	</p>
	...
	<p class="form-row">
		...
		<button type="submit" class="btn btn-dorado" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Iniciar sesión', 'woocommerce' ); ?></button>

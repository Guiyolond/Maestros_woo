...
<p><?php _e( "Hola, se ha agregado una nota a su pedido:", 'woocommerce' ); ?></p>

<blockquote><?php echo wpautop( wptexturize( $customer_note ) ) ?></blockquote>

<p><?php _e( "Para su referencia, los detalles de su pedido se muestran a continuación.", 'woocommerce' ); ?></p>

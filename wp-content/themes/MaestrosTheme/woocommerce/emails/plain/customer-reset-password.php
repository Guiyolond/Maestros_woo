...
echo __( 'Alguien solicitó que se restablezca la contraseña para la siguiente cuenta:', 'woocommerce' ) . "\r\n\r\n";
echo esc_url( network_home_url( '/' ) ) . "\r\n\r\n";
echo sprintf( __( 'Username: %s', 'woocommerce' ), $user_login ) . "\r\n\r\n";
echo __( 'Si esto fue un error, simplemente ignore este correo electrónico y no pasará nada.', 'woocommerce' ) . "\r\n\r\n";
echo __( 'Para restablecer su contraseña, visite la siguiente dirección:', 'woocommerce' ) . "\r\n\r\n";

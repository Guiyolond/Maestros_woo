      ...
      <div class="container fixed-top pt-5">
        <div class="row">
          ...
          <div class="align-items-end ">
            <a class="pr-3" href="<?php echo get_page_link('Cart'); ?>"><img src="<?php bloginfo('template_url'); ?>/img/Cart.png"></a>
            <a class="pl-3" href="<?php echo get_page_link('My-account'); ?>"><img src="<?php bloginfo('template_url'); ?>/img/User.png"></a>
          </div>
        </div>
      </div>
    </header>
